...
namespace ConsoleApp1
{
    public class Operator
    {
        ...
        private readonly Dictionary<MobileAccount, double> _topUsers;
        private readonly Dictionary<ulong, double> _topCalled;   
        private readonly Dictionary<ulong, MobileAccount> _accounts;
